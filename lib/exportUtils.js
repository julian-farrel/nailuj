...
export async function generateInstitutionalReport({ assets, weights, metrics }) {
  ...
  doc.text(
    "DISCLAIMER: This report is generated programmatically for informational purposes only and does not constitute investment advice. Past performance is not indicative of future results. Nailuj Terminal — Institutional Use Only.",
    margin,
    y,
  ...
  doc.setTextColor(140, 140, 140);
  doc.text(
    `Generated on ${today} by Nailuj Terminal Quantitative Research Desk. Institutional Use Only — Not For Redistribution.`,
    margin,
    y,
  ...
  doc.save(`Nailuj_Terminal_Report_${safeDateStr}.pdf`);
}
